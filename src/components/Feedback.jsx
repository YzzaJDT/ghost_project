...
<div className="py-12 w-full" id="feedback"> 
  ...
  {/* <div className="w-full bg-white rounded-none md:rounded-2xl shadow-lg p-8 flex flex-col md:grid md:grid-cols-2 gap-8"> */}
    <div className="w-full bg-white rounded-none sm:rounded-md md:rounded-xl lg:rounded-2xl shadow-lg px-4 sm:px-8 lg:px-32 xl:px-64 py-10">
      ...
      We Value Your Feedback 
        ...
        <div>
          ...
          <input
            ...
            required
            className="w-full border border-gray-300 rounded-lg py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none"
          />
        </div>
