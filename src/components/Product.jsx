...
import maecenasImg from '../assets/icons/maecenas.png'
import Aos from 'aos';
    ...
    <div>
         <div className='px-4 lg:px-14 max-w-screen-2xl mx-auto my-8' id='product'>
            ...
            <div className='md:w-3/5 mx-auto'>
              ...
              <p className='md:w-4/5 text-sm text-neutralGrey mb-8 leading-7'>Donec a eros justo. Fusce egestas tristique ultrices. 
              Nam tempor, augue nec tincidunt molestie, massa nunc varius arcu, at scelerisque elit erat a magna.
               Donec quis erat at libero ultrices mollis. In hac habitasse platea dictumst. Vivamus vehicula leo dui, at 
        ...
        <div className='px-4 lg:px-14 max-w-screen-2xl mx-auto bg-neutralSilver py-16' id='testimonial'>
            <div className='flex flex-col md:flex-row justify-between items-center gap-8' data-aos="fade-up">
              ...
              <div className='md:w-2/3 mx-auto'>
                <p className='md:w-4/5 text-sm text-neutralGrey mb-4 leading-7'>
                ...
                <h5 className='text-brandPrimary text-2xl font-semibold mb-2'>Tim Smith</h5>
