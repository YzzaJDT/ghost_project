        ...
        <div className=' lg:px-14 max-w-screen-2xl mx-auto py-16' id='about'>
          <div className='md:w-11/12 mx-auto flex flex-col md:flex-row justify-between items-center gap-12' data-aos="fade-up">
            ...
            <div className='md:w-4/5 mx-auto'>
              ...
              <p className='md:w-4/4 text-sm text-gray-800 mb-8 px-4 font-roboto text-justify'>At <span className='text-[#F0B609]'>Rolling Hills Towing</span> , our <span className='text-[#F0B609]'>mission</span> is simple: to provide fast, reliable, and affordable towing services to people in need — and to never leave anyone stranded on the road.
...
At <span className='text-[#F0B609]'> Rolling Hills Towing</span>, we understand that breakdowns and accidents are stressful. That’s why our professional team responds quickly, treats every customer with respect, and makes sure your vehicle is handled with care.
